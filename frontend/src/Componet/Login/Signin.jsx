...
const Signin = () => {
    ...
    //     enqueueSnackbar('Please fill the message properly.', { variant });
    // };

    // const handleClickVariant = (variant) => () => {
    //     enqueueSnackbar(' User Signup successfully!', { variant });
    // };
                                    ...
                                    <div className="text">
                                        <div className='gap-5 px-4'>
                                            <form onSubmit={formik.handleSubmit}>
                                                ...
                                                <button className="outline-none mt-2 shadow-2xl bg-red-600 rounded-lg  w-full p-3 transition-all ease-in-out duration-300 text-white hover:border-solid border font-mono font-bold text-lg" type="submit">Submit</button>
                                            </form>
                                            <div className="text">
                                            ...
                                            <div className="text">
                                                <div className='flex justify-center pt-4 text-center'>
                                                    ...
                                                    <Link to={'/login'}>
                                                        <span className='font-medium text-red-600 ps-2'>Signin</span>
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
