...
export const NavbarContent = [
...

    {
        ...
        icon: <ImProfile className="text-3xl" />,
        name: 'My Profile',
        link: '/user/profile'
    },
    // {
    ...
    // },
     {
        icon: <RiFileHistoryLine className="text-3xl" />,
        name: 'History',
        link: '/user/history'
    }, {
        name: 'Log-out',
        link: '/',
        icon: <HiOutlineLogout className='text-3xl font-extrabold text-red-500' />,
        log: true
    },
];
...
export const AdminNavbarContent = [
    ...
    , {
        ...
        icon: <RiOrderPlayFill className="text-3xl" />,
        name: 'Order',
        link: `/admin/order`
    },
    //  {
